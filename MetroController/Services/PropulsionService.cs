...
namespace IngameScript.Services
{
    ...
    {
        /// <summary>
        /// My estimated amount of resistance that the Metro receives. [N]
        /// </summary>
        private const int Resistance = 400;
        /// <summary>
        /// How much the friction will be increased/decreased every <see cref="UpdateFrequency.Update10"/> or <see cref="UpdateFrequency.Update1"/>.
        /// </summary>
        private const int FrictionStep = 3;
        /// <summary>
        /// Maximum allowed friction percentage.
        /// </summary>
        private const int MaxFriction = 90;
        /// <summary>
        ...
        public void Update()
        {
            ...
            if (shipVelocity > _targetVelocity)
            { // Hold your horses!
                DisableThrusters();
                IncreaseFriction();
            }
            else if (shipVelocity < _targetVelocity)
            { // Not that much though. Horses are for horsin' around, not standin' around.
                MaxThrusterOverride();
                DisableFriction();
            }
            else if (shipVelocity == _targetVelocity)
            { // Just like that. Perfectly balanced.
        ...
        /// <summary>
        /// Changes the velocity to the value of the <paramref name="targetVelocity"/> argument.
        /// </summary>
